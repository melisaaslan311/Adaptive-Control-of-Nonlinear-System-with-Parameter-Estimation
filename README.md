...
The plots below show the closed-loop response over a simulation run of `T = 200` s.
 
### Simulink Model Overview
<img width="1600" height="699" alt="Simulink model" src="https://github.com/user-attachments/assets/9f297580-5a31-4183-bbbf-74d1f69061dd" />
---
 
### Tracking Error — `e = xd − x`
> The error rapidly converges to zero, confirming that the controller successfully drives the plant state to the reference trajectory.
 
<img width="1600" height="825" alt="Tracking error convergence" src="https://github.com/user-attachments/assets/2ef10e39-781b-4f86-925c-f47ffd2b798b" />
---
 
### Parameter Estimate — `â` (a_hat)
> `â` converges toward the true value `a = 2.0` as the adaptive law refines the estimate online.
 
<img width="1600" height="849" alt="a_hat convergence" src="https://github.com/user-attachments/assets/1b11bbf3-71b3-4514-8b47-726605d56726" />
---
 
### Parameter Estimate — `b̂` (b_hat)
> `b̂` converges toward the true value `b = 1.0`, demonstrating successful online identification.
 
<img width="1600" height="847" alt="b_hat convergence" src="https://github.com/user-attachments/assets/6cfee9b4-0f14-435e-b26c-f44accfd7bba" />
---
